...
public class DialogueControlWiseJo : MonoBehaviour
{
    [Header("Componentes")]
    ...
    DialogueWiseJo dialogueScript;
    public bool checkpoint;

    void Awake() {
        dialogueScript = FindObjectOfType<DialogueWiseJo>();
    }
    ...
    public void NextSentence()
    {
        ...
        if(speechText.text.Length == sentences[index].Length)
        {
            ...
            else
            {
                ...
                dialogueScript.GetComponent<DialogueWiseJo>().enabled = false;
                checkpoint = true;
