...
public class DialogueControlDoms : MonoBehaviour
{
    [Header("Componentes")]
    ...
    DialogueDoms dialogueScript;
    public bool checkpoint;

    void Awake() {
        dialogueScript = FindObjectOfType<DialogueDoms>();
    }
    ...
    public void NextSentence()
    {
        ...
        if(speechText.text.Length == sentences[index].Length)
        {
            ...
            else
            {
                ...
                dialogueScript.GetComponent<DialogueDoms>().enabled = false;
