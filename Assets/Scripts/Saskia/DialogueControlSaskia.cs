...
public class DialogueControlSaskia : MonoBehaviour
{
    [Header("Componentes")]
    ...
    DialogueSaskia dialogueScript;

    void Awake() {
        dialogueScript = FindObjectOfType<DialogueSaskia>();
    }
    ...
    public void NextSentence()
    {
        ...
        if(speechText.text.Length == sentences[index].Length)
        {
            ...
            else
            {
                ...
                index = 0;
                dialogueObject.SetActive(false);
                dialogueScript.GetComponent<DialogueSaskia>().enabled = false;
