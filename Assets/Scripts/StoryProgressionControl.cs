...
public class StoryProgressionControl : MonoBehaviour
{
    [Header("Componentes")]
    ...
    void Awake() {
        storyProgression = FindObjectOfType<StoryProgression>();
    }
    ...
    private void Update()
    {
        if (storyProgression.isDialogueActive == true)
        {
    ...
    public void NextSentence()
    {
        ...
        if(speechText.text.Length == sentences[index].Length)
        {
            ...
            else
            {
                ...
                {
                    storyProgression.SetDialogueActive(false); // Change the value as needed
                }
