...
public class DialogueControlIlde : MonoBehaviour
{
    [Header("Componentes")]
    ...
    DialogueIlde dialogueScript;
    public bool checkpoint;

    void Awake() {
        dialogueScript = FindObjectOfType<DialogueIlde>();
    }
    ...
    public void NextSentence()
    {
        ...
        if(speechText.text.Length == sentences[index].Length)
        {
            ...
            else
            {
                ...
                dialogueScript.GetComponent<DialogueIlde>().enabled = false;
                checkpoint = true;
